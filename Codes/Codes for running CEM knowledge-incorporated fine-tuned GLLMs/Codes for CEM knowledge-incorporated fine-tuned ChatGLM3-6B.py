# Modify LLM_MODEL = "chatglm3-6b-fine-tuned" in model_config.py
#"chatglm3-6b-fine-tuned": {
#    "name": "chatglm3-fine-tuned",
#    "pretrained_model_name": "../chatglm3-6b-fine-tuned",
    ...
    for year in years:
        ...
        for i in range(len(Questions)):
            ...
            print("No Question", i + 1, "\n", "Right_Answer:", Answers[i],
                  "\nAnswer_from_CEM_knowledge-incorporated_fine-tuned_ChatGLM3-6B:", str(answer).strip().replace("\n", ""))
            df = pd.concat([df, df2], axis=0)
        save_df_to_excel(df, "All_answers_from_CEM_knowledge-incorporated_fine-tuned_ChatGLM3-6B" + year + ".xlsx", "sheet1")
