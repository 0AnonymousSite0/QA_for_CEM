...
llm = OpenAI(temperature=0.5, model="YOUR_FINE-TUNED_MODEL_ID")
...
for year in years:
  ...
  for i in range(len(Questions)):
    ...
    print("No of Question",i+1,"\n","Right_Answer:",Answers[i],"\n"+"Answer_from_CEM_knowledge-incorporated_fine-tuned_GPT-3.5-turbo:",str(answer1).strip().replace("\n",""))

    df = pd.concat([df, df2], axis=0)
  save_df_to_excel(df, "Answer_from_CEM_knowledge-incorporated_fine-tuned_GPT-3.5-turbo"+year+".xlsx", "sheet1")